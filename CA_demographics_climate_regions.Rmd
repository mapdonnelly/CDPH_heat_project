...
```{r}
labels<- c(white_alone="White", yes_hisp_lat_total="Hispanic", black_af_am_alone="Af. American", am_ind_alone="Am. Indian", asian_alone="Asian", nat_haw_pac_isl="Pacific Islander", some_other_alone="Other")
